...
def main(x, y, color):
    ...
    Titulo = pygame.display.set_caption("Dia XI")
    icono = pygame.image.load("imagenes/catpool.png")
    fondo = pygame.image.load("imagenes/mario.png")
    pygame.display.set_icon(icono)
    Pantalla.fill(color)
    Pantalla.blit(fondo, (0,0))
    cuadrado = pygame.draw.rect(Pantalla, rojo, (400, 500, 400, 500))
    linea = pygame.draw.line(Pantalla, rojo, (100, 104), (199, 184), 18)
    circulo = pygame.draw.circle(Pantalla, negro, (400, 500), 60)
    elipse = pygame.draw.ellipse(Pantalla, rojo, (100, 200, 100, 300))
    puntos = [(100, 200), (100, 300), (150, 100)]
    poligono = pygame.draw.polygon(Pantalla, verde, puntos, 8)
    print(linea)
    while True:
